		...
		<div class="shadow">
			...
			<div class="box">
				<div>
					...
					<form action="/show/payfor/resoult" method="post">
						<table style="border: none">
							<tr>
								<td style="text-align: center">
									<input type="hidden" name="orId" value="${curOrder.id}">
									<div>你购买的商品名称：${curOrder.product.proname}</div>
									<div>数量是：${curOrder.count}</div>
									<div>你需要支付的总金额是：${curOrder.totalPrice}</div>
