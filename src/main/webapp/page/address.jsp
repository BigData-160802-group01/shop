...
<div id="news" class="right-main">
    <div class="content">
        <form action="/show/createOrder" method="post">
            <div style="float: left;">
                ...
                <div class="userAdress" style="border: 2px solid rgb(250,126,49)">
                    ...
                    <div id="shopping">
                        ...
                        <input type="hidden" name="product.id" value="${needPay[0].product.id}">
                        <input type="hidden" name="totalPrice" value="${needPay[0].product.price}">
