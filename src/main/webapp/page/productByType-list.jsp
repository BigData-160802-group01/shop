	...
	<div class="wrap">
		<ul class="clearfix">
			<c:forEach items="${protypelist}" var="pty">
				<c:if test="${pty.totalListName==ptl.totalListName}">
...
<div id="position" class="wrap">
	您现在的位置：<a href="/show/index">易买网</a> &gt; <a href="product-list.jsp">${ProductList[0].proType.proTypeList.totalListName}</a> &gt; ${ProductList[0].proType.typeName}
</div>
<div id="main" class="wrap">
	...
	<div class="main">
		<div class="product-list">
			...
			<c:forEach items="${ptl.type}" var="pt">
				<c:forEach items="${pt.products}" var="pro">
				<li>
					<dl>
