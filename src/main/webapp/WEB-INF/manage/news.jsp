...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="/manager/news/list">新闻</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
	...
	<div class="main">
		...
		<div class="manage">
			<table class="list">
				...
				<c:forEach items="${newsList.datas}" var="nl">
					<tr>
						<td class="first w4 c">${nl.id}</td>
						<td>${nl.title}</td>
						<td class="w1 c">
							<a href="/manager/news/update/${nl.id}">修改</a>
							<a class="manageDel" href="/manager/news/delete/${nl.id}">删除</a>
						</td>
					</tr>
				</c:forEach>
