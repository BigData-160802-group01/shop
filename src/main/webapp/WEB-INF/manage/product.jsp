...
<div id="header" class="wrap">
    ...
    <div class="navbar">
        <ul class="clearfix">
            ...
            <li class="current"><a href="/manager/productClass/list">商品</a></li>
...
<div id="main" class="wrap">
    ...
    <div class="main">
        ...
        <div class="manage">
            <table class="list">
                ...
                <c:if test="${propag.datas!=null}">
                    <c:forEach var="tl" items="${propag.datas}" varStatus="stat1">
                        <tr>
                            <td class="first w4 c">${stat1.index+1}</td>
                            <td class="thumb">
                                <img src="${tl.pitch}" style="width: 60px;height: 60px"/>
                                <a href="/resources/product-view.html" target="_self">
                                    ${tl.proname}
                                </a>
                            </td>
                            <td class="w1 c">
                                <a href="/manager/product/modify/${tl.id}">修改</a>
                                <a class="manageDel" href="/manager/product/delete/${tl.id}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                </c:if>
    ...
    <div class="pager">
        <ul class="clearfix">
            <li><a href="/manager/product/list?pageIndex=1">首页</a></li>
            <c:forEach begin="1" end="${propag.totalPage}" step="1" var="ab">
                    <li class="current"><a href="/manager/product/list?pageIndex=${ab}">${ab}</a></li>
            </c:forEach>
            <li><a href="/manager/product/list?pageIndex=${propage.totalPage}">尾页</a></li>
        </ul>
    </div>
</div>
<div id="footer">
